<template>
    <div style="display: flex; line-height: 60px">
        <!--菜单伸缩-->
        <div>
            <!-- <el-icon style="font-size: 25px;cursor: pointer;">
                <component :is="icon" @click="collapse"></component>
            </el-icon> -->
        </div>
        ...
        <el-row>
            <!-- <el-col :span="8">
                <el-avatar shape="square" :size="50" :src="avatarIcon"
                    style="margin: 15px 5px -10px 0; border: 1px solid lightgrey"></el-avatar>
            </el-col> -->
            <el-col :span="16">
                <!-- dropdown下拉 -->
                <!-- <el-dropdown>
